...
present in the same atomic batch) for the same reason again: not an outcome
of a CI conclusion, not in OUTCOME_EXIT, a standing refusal that is a property
of a DECLARED CROSS-BEAD CONSTRAINT rather than of what Actions concluded.
...
EXIT_PAIR_REFUSED = 28     # MUST-LAND-TOGETHER counterpart not landed / not co-batched
