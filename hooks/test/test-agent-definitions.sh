...
assert_grep "$AGENTS_DIR/victor.md"   "sable-victor-manifest partition" "victor mechanically partitions one open-bead snapshot"
assert_grep "$AGENTS_DIR/victor.md"   "sable-victor-manifest stamp" "victor publishes canonical validation stamps through one tool"
assert_grep "$AGENTS_DIR/victor.md"   "fresh-anchors-unmoved" "victor states the pre-filter claim's anchor-only bound"
