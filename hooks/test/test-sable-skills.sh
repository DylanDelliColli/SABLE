...
assert_grep "$EXEC_SKILL" "sable-spawn-manager" "/sable-execute stands up the fleet via sable-spawn-manager (SABLE-dqhn)"
assert_no_grep "$EXEC_SKILL" "autostart"     "/sable-execute no longer claims launch kicks the managers"
